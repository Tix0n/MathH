...
START_TEST(pow_test) {
  x = s21_pow(S21_MIN_INFINITY, 1.5);
  y = pow(S21_MIN_INFINITY, 1.5);
  snprintf(str1, sizeof(str1), "%.6lf", x);
  snprintf(str2, sizeof(str1), "%.6lf", y);
  ck_assert_str_eq(str1, str2);
  x = s21_pow(S21_MIN_INFINITY, -1.5);
  ...
  snprintf(str2, sizeof(str1), "%.6lf", y);
  ck_assert_str_eq(str1, str2);
  x = s21_pow(S21_PL_INFINITY, S21_MIN_INFINITY);
  y = pow(S21_PL_INFINITY, S21_MIN_INFINITY);
  snprintf(str1, sizeof(str1), "%.6lf", x);
  snprintf(str2, sizeof(str1), "%.6lf", y);
  ck_assert_str_eq(str1, str2);
  x = s21_pow(S21_PL_INFINITY, S21_PL_INFINITY);
  y = pow(S21_PL_INFINITY, S21_PL_INFINITY);
  snprintf(str1, sizeof(str1), "%.6lf", x);
  snprintf(str2, sizeof(str1), "%.6lf", y);
  ck_assert_str_eq(str1, str2);
  x = s21_pow(S21_MIN_INFINITY, S21_MIN_INFINITY);
  y = pow(S21_MIN_INFINITY, S21_MIN_INFINITY);
  snprintf(str1, sizeof(str1), "%.6lf", x);
  snprintf(str2, sizeof(str1), "%.6lf", y);
  ck_assert_str_eq(str1, str2);
  x = s21_pow(-1.0, 0.0);
...
START_TEST(fmod_test) {
  ...
  snprintf(str2, sizeof(str1), "%.6lf", y);
  ck_assert_str_eq(str1, str2);
  x = s21_fmod(0.0, S21_MIN_INFINITY);
  y = fmod(0.0, S21_MIN_INFINITY);
  snprintf(str1, sizeof(str1), "%.6lf", x);
  snprintf(str2, sizeof(str1), "%.6lf", y);
  ck_assert_str_eq(str1, str2);
  x = s21_fmod(my_inf, 3);
